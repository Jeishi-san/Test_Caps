                        ...
                        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
                            <div>
                                ...
                                <ul className="mt-8 space-y-4">
                                    {[
                                        { id: 'encryption', text: 'Implement envelope encryption for secure key management' },
                                        { id: 'lsb', text: 'Develop efficient LSB embedding algorithms for various image formats' },
                                        { id: 'cloud', text: 'Create scalable cloud storage integration with concurrent uploads' },
                                        { id: 'ui', text: 'Design intuitive user interfaces for complex security operations' },
                                    ].map((item) => (
                                        <li key={item.id} className="flex items-start">
                                            ...
                                            <span className="ml-3 text-slate-300">{item.text}</span>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    {[
                                        { id: 'healthcare', title: 'Healthcare', desc: 'Protect patient records and medical documents' },
                                        { id: 'legal', title: 'Legal', desc: 'Secure confidential case files and contracts' },
                                        { id: 'finance', title: 'Finance', desc: 'Safeguard financial reports and transactions' },
                                        { id: 'research', title: 'Research', desc: 'Protect intellectual property and study data' },
                                    ].map((item) => (
                                        <div key={item.id} className="rounded-lg bg-slate-800/50 p-4">
                    ...
                    <div className="mx-auto max-w-7xl px-6 lg:px-8">
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
                            ...
                            <div>
                                ...
                                <ul className="mt-4 space-y-2">
                                    {[
                                        { id: 'laravel', name: 'Laravel 10' },
                                        { id: 'react', name: 'React + Inertia.js' },
                                        { id: 'mysql', name: 'MySQL' },
                                        { id: 'backblaze', name: 'Backblaze B2' },
                                        { id: 'python', name: 'Python (Steganography)' },
                                    ].map((tech) => (
                                        <li key={tech.id} className="text-sm text-slate-300">
                                            {tech.name}
                                        </li>
                                    ))}
                                </ul>
